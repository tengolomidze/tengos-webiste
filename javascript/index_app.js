...
body2div.style.animationName = 'body2divanim2'
...
function open2(){
    body2div.style.animationName = 'body2divanim'
    body2div.style.right = '0vw'
}
...
if(scrollnumber > 100 && body.style.left == '0vw'){
    open()
...
window.addEventListener('scroll', function(){
    ...
    if(scrollnumber > 800 && body.style.left == '0vw'){
        open2()
        console.log("animation2 opened!!!!!!!!!!!!!")
    }
